// From the A6 source code, from the CompSys course
#pragma once
//#include "csapp.h"
#include <assert.h>
#include <errno.h>
 ...
 *   (if command is a /msg, then recipient username and actual message stored in
 * args[0..1]).
 */
command_t parse_command(char *input, args_t args);

/*
 * extract arguments from a line of user input and store in args.
 */
size_t extract_args(char *input, args_t args);
